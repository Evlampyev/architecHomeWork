# Компоновщик — это структурный паттерн, позволяющий представлять группы
# объектов в виде дерева. В дальнейшем позволяет работать с составным объектом,
# как с одиночным.
...
if __name__ == "__main__":
    ...
    # Добавление компоновщика 1 в компановщик 2
