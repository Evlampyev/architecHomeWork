...
# От абстрактной фабрики отличается тем, что делает акцент на пошаговом
# конструировании объекта.
# Строитель возвращает объект на последнем шаге, тогда как абстрактная
# фабрика возвращает объект немедленно.
